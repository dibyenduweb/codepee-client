const Banner = () => {
  return (
    <div className="max-w-7xl mx-auto">
      <div
        className="relative bg-cover bg-center min-h-[50vh] text-white py-16 px-8 font-sans"
        style={{
          backgroundImage:
            "url('https://i.pinimg.com/originals/6f/1e/86/6f1e86ffdb2926aead1616cc8719ca41.jpg')",
        }}
      >
        {/* Overlay Layer */}
        ...
        <div className="relative z-10 container mx-auto flex flex-col md:flex-row justify-between items-center min-h-[50vh] gap-x-6 gap-y-8">
          ...
          <div className="md:w-1/2 flex justify-center">
            <a href="https://forms.gle/7H3Yc83xMvnoMXqF6" target="_blank" rel="noopener noreferrer">
              <button
                type="button"
