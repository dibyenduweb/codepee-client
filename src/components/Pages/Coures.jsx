        ...
        {courseData.map((course, id) => (
          <div key={id} className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              ...
              <h5 className="text-lg font-semibold mb-2">{course.title} <span className="text-sm bg-red-600 text-white px-2 rounded-xl">Bengali</span> </h5>
              <h5 className="text-lg font-semibold mb-2">Price:₹{course.price}</h5>
              ...
              <button disabled className="ml-4 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">
